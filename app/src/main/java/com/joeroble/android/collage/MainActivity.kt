package com.joeroble.android.collage
...
class MainActivity : AppCompatActivity() {
    ...
    private fun takePicture() {
        ...
        if(photoFile != null){
            ...
            photoUri = FileProvider.getUriForFile(
                this,
                "com.joeroble.android.collage.fileprovider",
                photoFile
            )
    ...
    fun handleImage(result: ActivityResult){
    ...
    override fun onWindowFocusChanged(hasFocus: Boolean) {
        ...
        Log.d(TAG, "on window focus changd $hasFocus visible image at $visibleImagePath")
        if (hasFocus){
